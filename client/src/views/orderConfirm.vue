      ...
      <div class="checkout-order">
        ...
        <div class="order-foot-wrap">
          ...
          <div class="next-btn-wrap">
            ...
            <!--<router-link class="btn btn--m btn--red" @click="payMent">去支付</router-link>-->
          </div>
        </div>
      </div>
    </div>
...
<script>
import HavHeader from '../components/HavHeader'
    ...
    OrderList() {
      axios.post('/users/cartList').then(res => {
        ...
        this.cartList.forEach((item) => {
          ...
          this.ordertatal = this.totalPrice+this.shipping-this.discount+this.tax;
        })
      })
    },
    payMent() {
